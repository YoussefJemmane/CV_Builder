...
export declare class EventManager extends EventEmitter<EventManagerEventsMap> {
    ...
    subscribe(eventNames: ChromiumBidi.EventNames[], contextIds: BrowsingContext.BrowsingContext[], channel: BidiPlusChannel): Promise<string>;
    unsubscribe(eventNames: ChromiumBidi.EventNames[], contextIds: BrowsingContext.BrowsingContext[], channel: BidiPlusChannel): Promise<void>;
