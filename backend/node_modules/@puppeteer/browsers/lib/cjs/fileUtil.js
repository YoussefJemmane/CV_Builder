...
async function extractTar(tarPath, folderPath, decompressUtilityName) {
    ...
    return await new Promise((fulfill, reject) => {
        ...
        const unpack = (0, child_process_1.spawn)(exports.internalConstantsForTesting[decompressUtilityName], ['-d'], {
        ...
        (0, fs_1.createReadStream)(tarPath).pipe(createTransformStream(unpack)).pipe(tar);
    });
}
/**
 * @internal
