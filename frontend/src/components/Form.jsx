...
const Form = () => {
  ...
  const removeTechnicals = (index) => {
    if (index === 0) {
      return;
    }
    const updatedTechnicals = [...technicals];
    updatedTechnicals.splice(index, 1);
    ...
    <>
      ...
      <div className=" bg-base-200  min-h-screen">
            ...
            <form action="">
              <section class=" dark:bg-gray-900" x-show="step === 1">
                      ...
                      <div className="space-y-4 md:space-y-6">
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            name="profile"
                            id="profile"
                            placeholder="I am Developer who workes remotely"
                            className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            required=""
                            onChange={(e) =>
                              setPersonalInfo({
                ...
                <div className="flex justify-center  pb-4">
                  <button
                    type="button"
                    className="btn btn-primary mr-[-170px]"
                    data-theme="emerald"
                    x-on:click="step = 2"
                  >
                    <svg
                  ...
                  {educations.map((education, index) => (
                    ...
                    >
                      <div className="card-body">
                        ...
                        {index !== 0 && ( // Add a condition to exclude the button for the first card
        <button
          type="button"
          className="  mr-6"
          data-theme="emerald"
                        ...
                        <div className="space-y-4 md:space-y-6">
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => {
                                const updatedEducations = [...educations];
                                updatedEducations[index].institution =
                                  e.target.value;
                                setEducations(updatedEducations);
                              }}
                            />
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => {
                                const updatedEducations = [...educations];
                                updatedEducations[index].country =
                                  e.target.value;
                                setEducations(updatedEducations);
                              }}
                            />
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => {
                                const updatedEducations = [...educations];
                                updatedEducations[index].diplome =
                                  e.target.value;
                                setEducations(updatedEducations);
                              }}
                            />
                        ...
                        <div className="space-y-4 md:space-y-6">
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => {
                                const updatedexperiences = [...experiences];
                                updatedexperiences[index].position =
                                  e.target.value;
                                setExperiences(updatedexperiences);
                              }}
                            />
                          ...
                          <div>
                            <label
                              htmlFor={`experienceStartDate-${index}`}
                              className="block mb-2 text-sm font-medium dark:text-white"
                            >
                              Your Start Date
                            </label>
                            <input
                              ...
                              onChange={(e) => {
                                const updatedexperiences = [...experiences];
                                updatedexperiences[index].experienceStartDate =
                                  e.target.value;
                                setExperiences(updatedexperiences);
                              }}
                            />
                          ...
                          <div>
                            <label
                              htmlFor={`experienceEndDate-${index}`}
                              className="block mb-2 text-sm font-medium dark:text-white"
                            >
                              Your End Date
                            </label>
                            <input
                              ...
                              onChange={(e) => {
                                const updatedexperiences = [...experiences];
                                updatedexperiences[index].experienceEndDate =
                                  e.target.value;
                                setExperiences(updatedexperiences);
                              }}
                            />
                          ...
                          <div>
                            ...
                            <textarea
                              ...
                              placeholder="I built a Full Stack web application using MERN Stack"
                        ...
                        <div className="space-y-4 md:space-y-6">
                          <div>
                            ...
                            <input
                              ...
                              id={`title-${index}`}
                              className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                              placeholder="CV Builder application"
                              required=""
                              value={project.title}
                              onChange={(e) => {
                                const updatedprojects = [...projects];
                          ...
                          <div>
                            ...
                            <textarea
                              ...
                              id={`description-${index}`}
                              className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                              placeholder="this is an application that storing information and download a cv about those infos"
                              required=""
                          ...
                          <div>
                            ...
                            <input
                              ...
                              name="link"
                              id={`link-${index}`}
                              placeholder="https://github.com/YoussefJemmane/CV_Builder"
                              className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                              required=""
                              onChange={(e) => {
                                const updatedprojects = [...projects];
        ...
        <button
          ...
          className="  mr-6"
          data-theme="emerald"
          onClick={() => removeTechnicals(index)}
          style={{ background: 'white' }}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        >
          ...
          >
            <path d="M19 5L5 19M5 5l14 14" />
                        ...
                        <div className="space-y-4 md:space-y-6">
                          ...
                          <div>
                            ...
                            <textarea
                              ...
                              id={`description-${index}`}
                              className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                              placeholder="I can Work with a team and contribute in an open source project"
                              required=""
                              value={skill.description}
                              onChange={(e) => {
                                const updatedskills = [...skills];
                                updatedskills[index].description =
                                  e.target.value;
                                setSkills(updatedskills);
                              }}
                            />
              ...
              <section className=" dark:bg-gray-900" x-show="step === 7">
                <div className="flex flex-wrap items-center justify-center p-[50px]">
