...
const Template2 = () => {
  ...
  const download = `http://localhost:3000/api/resumes/resume/${resumeId}/template2/download`;
  useEffect(() => {
        ...
        <div>
          <div className='flex justify-center '>
            <div className='w-[800px] border rounded bg-white'>
              ...
              <div className='flex justify-center'>
                <p className='pt-2 font-bold text-purple-700'>
                ...
                {resume && resume.projects.map((project, index) => {
                  return (
                    <div className='pt-[10px] pl-[16px] pb-[10px]' key={index}>
                      ...
                      <p>Link : <a className='text-purple-700' href={project.link}>{project.link}</a></p>
